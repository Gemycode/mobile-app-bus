      ...
      >
        ...
        <View style={styles.section}>
          ...
          {buses.slice(0, 3).map((bus) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('BusDetails' as never, { busId: bus.id } as never)}
            >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Routes' as never)}>
          ...
          {routes.slice(0, 2).map((route) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('RouteDetails' as never, { routeId: route.id } as never)}
            >
